        ...
        extends AbstractEntityResource
{
    ...
    public X509Resource( @Structure Module module, @Service RestApiService restApi )
    {
    ...
    protected Representation representJson()
    {
        ...
        // Representation
        return new StringRepresentation( valuesFactory.x509( x509 ).toString(), MediaType.APPLICATION_JSON );
    }
