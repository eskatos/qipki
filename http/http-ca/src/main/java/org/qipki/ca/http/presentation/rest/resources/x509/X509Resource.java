        ...
        extends AbstractEntityResource
{
    ...
    public X509Resource( @Structure ObjectBuilderFactory obf, @Service RestApiService restApi )
    {
        super( obf, restApi );
    }
    ...
    protected Representation representJson()
    {
        ...
        // Representation
        return new StringRepresentation( valuesFactory.x509( x509 ).toJSON(), MediaType.APPLICATION_JSON );
    }
