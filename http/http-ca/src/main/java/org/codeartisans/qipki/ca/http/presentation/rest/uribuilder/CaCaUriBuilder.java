...
public final class CaCaUriBuilder
        extends AbstractUriBuilder
{


    /* package */ CaCaUriBuilder( Reference baseRef, String identity, String special )
    {
        super( baseRef, identity, special );
    }

    public CaCaUriBuilder withIdentity( String identity )
    {
